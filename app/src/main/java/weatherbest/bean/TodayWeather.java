...
public class TodayWeather {
    ...
    public String toString() {
        return "TodayWeather{" +
                ...
                ", temperatureH='"+ temperatureH1 + '\'' +
                ", temperatureL='"+ temperatureL1 + '\'' +
                ", climate='"+ climate1 + '\'' +
                ", wind='"+ wind1 + '\'' +
                ", week_today='"+ week_today2 + '\'' +
                ", temperatureH='"+ temperatureH2 + '\'' +
                ", temperatureL='"+ temperatureL2 + '\'' +
                ", climate='"+ climate2 + '\'' +
                ", wind='"+ wind2 + '\'' +
                ", week_today='"+ week_today3 + '\'' +
                ", temperatureH='"+ temperatureH3 + '\'' +
                ", temperatureL='"+ temperatureL3 + '\'' +
                ", climate='"+ climate3 + '\'' +
                ", wind='"+ wind3 + '\'' +
                ", week_today='"+ week_today4 + '\'' +
                ", temperatureH='"+ temperatureH4 + '\'' +
                ", temperatureL='"+ temperatureL4 + '\'' +
                ", climate='"+ climate4 + '\'' +
                ", wind='"+ wind4 + '\'' +
                ", week_today='"+ week_today5 + '\'' +
                ", temperatureH='"+ temperatureH5 + '\'' +
                ", temperatureL='"+ temperatureL5 + '\'' +
                ", climate='"+ climate5 + '\'' +
                ", wind='"+ wind5 + '\'' +'}';
